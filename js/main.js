/* ==========================================================================
   GLORY ZONE CHURCH — MAIN JAVASCRIPT
   ========================================================================== */
...
(function () {
  ...
  handleFormSubmit('newsletter-form', 'You\'re subscribed! Welcome to the Glory Zone family.');
  ...
  function showToast(message, type = 'success') {
    ...
    Object.assign(toast.style, {
      ...
      background: type === 'success' ? '#7B2800' : '#E86010',
    ...
    setTimeout(() => { toast.style.opacity = '0'; toast.style.transform = 'translateX(-50%) translateY(8px)'; setTimeout(() => toast.remove(), 300); }, 4000);
  }
  ...
  document.querySelectorAll('.accordion__btn').forEach(btn => {
    btn.addEventListener('click', () => {
      ...
      if (!isOpen) { item.classList.add('accordion--open'); if (panel) panel.style.maxHeight = panel.scrollHeight + 'px'; }
    });
  });
